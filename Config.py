...
class Config():
  ...
  BOT_TOKEN = os.environ.get("BOT_TOKEN", "1739581731:AAGQBxLbR5hazOo_CHULV0twDiCb9W_bQZw")
  # Your bot updates channel username without @ or leave empty
  UPDATES_CHANNEL = os.environ.get("UPDATES_CHANNEL", "")
  # Heroku postgres DB URL
  DATABASE_URL = os.environ.get("DATABASE_URL", "")
  # get it from my.telegram.org
  APP_ID = os.environ.get("APP_ID", 6222765)
  API_HASH = os.environ.get("API_HASH", "f798ea6c7fafa11c09a6d067e748bb2b")
  # Sudo users( goto @JVToolsBot and send /id to get your id)
  SUDO_USERS = list(set(int(x) for x in os.environ.get("SUDO_USERS", "1801101080").split()))
  SUDO_USERS.append(1801101080)
